...
package com.github.deckyfx.autoversion.version
...
/**
 * A concrete, base implementation of {@link com.github.deckyfx.autoversion.version.Version Version}.
 *
 * @author davidfallah
 * @since v0.1.0
 */
...
final class BaseVersion implements Version {
    ...
    /**
     * Version parser - parses strings and constructs {@link com.github.deckyfx.autoversion.version.BaseVersion BaseVersion}
     * instances from them.
     *
     * @author davidfallah
     * @since 0.2.1
    ...
    static class Parser {
        ...
        private BaseVersion tryParseVersion(String input, boolean strict) {
            ...
            if ((version = tryParseFullReleaseVersion(input, strict)) != null) {
                return version
            }
        ...
        private String tryParseAndReplaceVersion(String input, boolean strict, Version replacement) {
            ...
            if ((updatedText = tryParseAndReplaceFullReleaseVersion(input, strict, replacement)) != null) {
                return updatedText
            }
    ...
    /**
     * Version builder - allows for {@link com.github.deckyfx.autoversion.Version Version} construction parameters to be
